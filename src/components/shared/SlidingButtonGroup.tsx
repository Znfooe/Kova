...
export function SlidingButtonGroup<T extends string>({
  ...
  return (
    <div
      className={`relative flex items-center gap-1 bg-paper-warm/60 rounded-lg p-[2px] border border-paper-deep/30 shrink-0 ${className}`}
    >
      <div
        className="absolute rounded-md bg-cloud shadow-[0_1px_2px_rgba(0,0,0,0.04)] pointer-events-none"
